    ...
    <section id="benefits" className="py-24 px-6 bg-[#f8fafc]">
      <div className="max-w-[1156px] mx-auto">
        <div className="text-center mb-16 reveal-on-scroll">
          <h2 className="text-3xl lg:text-4xl font-black text-slate-900 mb-4">مزایای <span className="text-brand-red">سازمانی</span></h2>
          <p className="text-slate-500 font-bold">چرا بزرگ‌ترین سازمان‌ها تی‌تی‌شهر را انتخاب می‌کنند؟</p>
        </div>
